...
tokenizer = AutoTokenizer.from_pretrained('/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/xuhao19/model/bloom/bloom-7b1')

BASE_MODEL = "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/xuhao19/model/bloom/bloom-7b1"

LORA_WEIGHTS = "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/xuhao19/HOPE4OUTPUT/llmsft/bloom_lora/v1"
